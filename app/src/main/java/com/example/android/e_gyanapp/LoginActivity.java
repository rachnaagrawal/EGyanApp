        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validate()) {
                    ...
                    editor.putString("NameKey",currentUser.getUserName());
                    editor.putString("EnrollKey",currentUser.getEnrollment());
                    ...
                    if (currentUser != null) {
                        ...
                        if(msharedpreferences.contains("EmailKey")){//User Logged in Successfully Launch You home screen activity
